#ifndef __ROBOTICS_SCENARIO_H__
#define __ROBOTICS_SCENARIO_H__
...
public:
  using Ptr = std::shared_ptr<robotics_scenario::Scenario<ActionT>>;

  Scenario() { plugin_muxer_ = nullptr; };
  virtual ~Scenario() = default;

  bool on_configure(rclcpp_lifecycle::LifecycleNode::WeakPtr parent_node,
                    const std::vector<std::string> &plugin_lib_names, robotics_scenario::ScenarioMuxer *plugin_muxer) {
