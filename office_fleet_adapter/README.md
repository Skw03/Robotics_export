...
This is an implementation of the Python-based fleet adapter template for selected demo worlds: Hotel, Office, Airport Terminal, and Clinic.
...
- The **fleet adapter** receives task requests and interfaces with the fleet manager to receive robot state information, as well as send task and navigation commands to the robots
...
You can interact with the endpoints with FastAPI's automatic documentation. First launch a demo world, then visit the base URL with `/docs` appended at the end. Do take note that the port number for each demo fleet is specified in `office_demos/office_demos/config/`.
...
Request URL: `http://127.0.0.1:22011/open-rmf/office_demos_fm/status/`
##### Response Body:
```json
{
  "data": {
...
Request URL: `http://127.0.0.1:22011/open-rmf/office_demos_fm/status/?robot_name=tinyRobot1`
##### Response Body:
```json
{
  "data": {
...
Request URL: `http://127.0.0.1:22011/open-rmf/office_demos_fm/navigate/?robot_name=tinyRobot1`
##### Request Body:
```json
{
  "map_name": "L1",
...
Request URL: `http://127.0.0.1:22011/open-rmf/office_demos_fm/stop/?robot_name=tinyRobot1`
##### Response Body:
```json
{
  "success": true,
...
Request URL: `http://127.0.0.1:22011/open-rmf/office_demos_fm/start_activity/?robot_name=tinyRobot1`
##### Request Body:
```json
{
  "map_name": "L1",
